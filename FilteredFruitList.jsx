    ...
    <>
      <div className="bg-gray-950 p-10">
        ...
        <div className="flex justify-center flex-col w-96 h-auto">
          <p className="text-start ml-2 flex text-sm  text-red-600">
            {ref.current}
          </p>{" "}
          <input
            value={add}
        ...
        <ul className="text-white">
          {list.map((item, i) => (
            <li
              key={i}
              className="w-96 h-10  m-4 text-start text-blue-400 bg-black text-lg border-[3px] rounded-md border-rose-600"
            >
              {item}
            </li>
          ))}
